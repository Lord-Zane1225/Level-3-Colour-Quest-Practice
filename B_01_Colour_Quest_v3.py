...
class StartGame:
    ...
    def __init__(self):
        ...
        # strings for labels
        intro_string = "In each round you will be invited to choose a colour. Your goal is to beat the target score and win the round (and keep your points). "
    ...
    def check_rounds(self):
        ...
        try:
            ...
            if rounds_wanted > 0:
                # Clear entry box and reset instruction label so that when users play
                # a new game, they don't see an error message.
...
class Play:
    ...
    def round_results(self, user_choice):
        ...
        # code for when the game has ended
        if rounds_played == rounds_wanted:
            ...
            self.end_game_button.config(text="Play Again", bg="#006600", compound="right", width=200)
...
class DisplayHints:
    ...
    def __init__(self, partner):
        ...
        # heading
        self.hint_heading_label = Label(self.hint_frame, text="Help / Info", font=("Arial", 14, "bold"))
        ...
        # dismiss button
        self.dismiss_button = Button(self.hint_frame, font=("Arial", 12, "bold"), text="Dismiss", bg="#CC6600", fg="#FFFFFF",
